...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post calls_url, params: { call: { content: @call.content, doctor_id: @call.doctor_id, title: @call.title, user_id: @call.user_id, when: @call.when } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { content: @call.content, doctor_id: @call.doctor_id, title: @call.title, user_id: @call.user_id, when: @call.when } }
