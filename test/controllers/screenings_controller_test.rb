...
class ScreeningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screening" do
    assert_difference('Screening.count') do
      post screenings_url, params: { screening: { check_date: @screening.check_date, title: @screening.title, user_id: @screening.user_id } }
    end
  ...
  test "should update screening" do
    patch screening_url(@screening), params: { screening: { check_date: @screening.check_date, title: @screening.title, user_id: @screening.user_id } }
